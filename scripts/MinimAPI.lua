...
MinimapAPI:AddPickup("brokenheart", "brokenheart", 5, 10, 84, MinimapAPI.PickupNotCollected, "hearts", 10550)
...
MinimapAPI:AddIcon("deceiverheart", Icons, "deceiverheart", 0)
MinimapAPI:AddPickup("deceiverheart", "deceiverheart", 5, 10, 87, MinimapAPI.PickupNotCollected, "hearts", 10150)
...
MinimapAPI:AddPickup("enigmaheart", "enigmaheart", 5, 10, 92, MinimapAPI.PickupNotCollected, "hearts", 10550)

MinimapAPI:AddIcon("capriciousheart", Icons, "capriciousheart", 0)
MinimapAPI:AddPickup("capriciousheart", "capriciousheart", 5, 10, 93, MinimapAPI.PickupNotCollected, "hearts", 10650)

MinimapAPI:AddIcon("balefulheart", Icons, "balefulheart", 0)
MinimapAPI:AddPickup("balefulheart", "balefulheart", 5, 10, 94, MinimapAPI.PickupNotCollected, "hearts", 10550)

MinimapAPI:AddIcon("harlotheart", Icons, "harlotheart", 0)
MinimapAPI:AddPickup("harlotheart", "harlotheart", 5, 10, 95, MinimapAPI.PickupNotCollected, "hearts", 10350)

MinimapAPI:AddIcon("miserheart", Icons, "miserheart", 0)
MinimapAPI:AddPickup("miserheart", "miserheart", 5, 10, 96, MinimapAPI.PickupNotCollected, "hearts", 10750)
...
MinimapAPI:AddPickup("fetteredheart", "fetteredheart", 5, 10, 98, MinimapAPI.PickupNotCollected, "hearts", 10650)
