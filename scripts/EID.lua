...
if true then
	...
	EID:addCard(CustomConsumables.KING_OF_DIAMONDS, "Lose all your coins and spawn a proportional number of pickups #Can spawn an item or trinket with a certain chance that grows with the amount of coins and reaches 100% at 18 and 42 coins, respectively")
