...
if true then
	...
	EID:addCard(CustomConsumables.KING_OF_SPADES, "Lose all your keys and spawn a number of pickups proportional to the amount of keys lost #At least 9 {{Key}} keys is needed for a trinket, and at least 21 for an item #If Isaac has {{GoldenKey}} Golden key, it is removed too and increases total value")
	EID:addCard(CustomConsumables.KING_OF_CLUBS, "Lose all your bombs and spawn a number of pickups proportional to the amount of bombs lost #At least 9 {{Bomb}} bombs is needed for a trinket, and at least 21 for an item #If Isaac has {{GoldenBomb}} Golden bomb, it is removed too and increases total value")
	EID:addCard(CustomConsumables.KING_OF_DIAMONDS, "Lose all your coins and spawn a number of pickups proportional to the amount of coins lost #At least 24 {{Coin}} coins is needed for a trinket, and at least 54 for an item")
