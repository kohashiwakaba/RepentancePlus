...
if true then
	...
	EID:addCollectible(CustomCollectibles.HANDICAPPED_PLACARD, "Places a handicapped placard on the ground #Every enemy inside the placard's 'aura' gets weakened and may spawn bone spurs on death #The 'aura' of placard becomes bigger the more damage you take in a room")
