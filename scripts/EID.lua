...
if true then
	...
	EID:addCollectible(CustomCollectibles.MAGIC_PEN, "Double tap shooting button to spew a line of {{ColorRainbow}}rainbow{{CR}} creep in the direction you're firing #Random status effect is applied to enemies walking over that creep #Has a 4 seconds cooldown")
	...
	EID:addCollectible(CustomCollectibles.SCALPEL, "Makes you shoot tears in the opposite direction #From the front, you will frequently shoot bloody tears that deal 75% of your damage #All other weapon types will still be fired from the front as well")
	...
	EID:addCollectible(CustomCollectibles.MAGIC_MARKER, "Drops a random tarot card when picked up #On use, transform held tarot card by increasing its number by 1 (or reducing for reversed tarots)")
	...
	EID:addCard(CustomConsumables.KING_OF_SPADES, "Lose all your keys and spawn a proportional number of pickups #Can spawn a trinket or an item with a certain chance that grows with the amount of keys and reaches 100% at 9 and 21 keys, respectively #Removes {{GoldenKey}}Golden key as well")
	EID:addCard(CustomConsumables.KING_OF_CLUBS, "Lose all your bombs and spawn a proportional number of pickups #Can spawn a trinket or an item with a certain chance that grows with the amount of bombs and reaches 100% at 9 and 21 bombs, respectively #Removes {{GoldenBomb}}Golden bomb as well")
	...
	EID:addCard(CustomConsumables.SACRIFICIAL_BLOOD, "{{ArrowUp}}Gives +1.25 DMG up that depletes over the span of 25 seconds #Stackable #{{ArrowUp}}Heals you for one red heart if you have Ceremonial Robes #{{Warning}}Damage depletes quicker the more Blood you used subsequently")
	...
	EID:addEntity(5, 10, 97, "Empty Heart", "Grants you one Abyss{{Collectible706}}locust when entering a new floor")
	EID:addEntity(5, 10, 98, "Fettered Heart", "Grants 1.5 soul hearts, but requires a key to pick it up")
	EID:addEntity(5, 10, 99, "Zealot Heart", "Grants you one Lemegeton{{Collectible712}}wisp when entering a new floor")
...
if true then
	...
	EID:addCollectible(CustomCollectibles.RUBIKS_CUBE, "사용시 5% (20회 사용시 100%)의 확률로 퍼즐을 풀고 {{Collectible"..tostring(CustomCollectibles.MAGIC_CUBE).."}}Magic Cube 아이템으로 교체됩니다.", "루빅큐브", "ko_kr")
